...
- `pfra-calculator.js` adapts the existing UI to PFRA 2026 scoring through modules in `src/pfra/`.
...
- PFRA UI integration still uses the current legacy controls, but selectors, mapping, rendering, scoring, and standards loading are now separated.
